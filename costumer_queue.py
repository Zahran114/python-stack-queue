    ...
    while True:
        ...
        if Pilihan == "1":
            ...
            if removed_transaction:
                print(f"Transaksi yang dihapus: {removed_transaction.customer_name} - {removed_transaction.transaction_type}")
            else:
            ...
            if next_transaction:
                print(f"Transaksi berikutnya: {next_transaction.customer_name} - {next_transaction.transaction_type}")
            else:
                print("Antrian transaksi kosong.")
            print()
